...
{
    private String idTipoApoyo;
    private String nombreTipoApoyo;
    /**
     * @return the idTipoApoyo
     */
    public String getIdTipoApoyo() {
        return idTipoApoyo;
    }
    /**
     * @param idTipoApoyo the idTipoApoyo to set
     */
    public void setIdTipoApoyo(String idTipoApoyo) {
