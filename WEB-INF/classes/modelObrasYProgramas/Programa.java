...
public class Programa
{
    ...
    public Programa(ResultSet tr){
        try{
            ...
            this.setIdPrograma(tr.getString(i)); i++;
            this.setNombrePrograma(tr.getString(i));i++;
            ...
            this.tipoApoyo.setIdTipoApoyo(tr.getString(i));i++;
            this.tipoApoyo.setNombreTipoApoyo(tr.getString(i));i++;
            ...
            this.setMontoDeApoyo(tr.getString(i));i++;

            
            this.setTotalBeneficiarios(tr.getString(i));i++;
            this.setTotalMunicipios(tr.getString(i));i++;
            
            
            this.setObservaciones(tr.getString(i));i++;
            this.setAnoPrograma(tr.getString(i));i++;
            this.setInversionTotal(tr.getString(i));i++;
            this.setTipoMoneda(tr.getString(i));i++;
            this.setLineaBase(tr.getString(i));i++;
            this.setMetaBeneficiarios(tr.getString(i));i++;
            this.setAbsoluto(tr.getString(i));i++;
            this.setPorcentual(tr.getString(i));i++;
